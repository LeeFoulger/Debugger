...
{
	_ctf_variant_flag_at_home_to_score_flag = 0,
...
{
	_ctf_variant_home_flag_waypoint_settings_never = 0,
...
{
	_ctf_variant_game_type_settings_multi_flag = 0,
...
{
	_ctf_variant_respawn_settings_normal = 0,
